function [seeds,rvalues] = analyzePRFgscomputesupergridseeds(seeds,stimulus,data,modelfun,maxpolydeg,dimdata,dimtime,typicalgain,noisereg)
...
%
% history:
% 2020/02/02 - Yuasa: modify for GS
