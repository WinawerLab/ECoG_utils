function [onsets, onsets_run, data, hdr, triggerChannels] = NY668_getOnsetsHeaderData(ses_label)

patientID = 668;
pth = '/Volumes/server/Projects/BAIR/Data/Raw/ECoG/';
datapth = [pth num2str(patientID) '/NY668_BAIR_VisualPilot/'];
if ses_label == 1
    datafiles = {'NY668_BAIR_visualpilot_Clin1', 'NY668_BAIR_visualpilot_Clin2'};
elseif ses_label == 2
	datafiles = {'NY668_BAIR_visualpilot_Day2_Clin1', 'NY668_BAIR_visualpilot_Day2_Clin2'};
end
...
% TO DO: ADAPT CODE BELOW TO THIS PATIENT
