...
% There's a mismatch for one set of electrodes that are labeled 'RDS' in
% the data, but 'RDSI' in the electrode list provided by SoM. Hack by
% overwriting names in the hdr:
...
morebadChannels = [1 46 94 99 107 119];
