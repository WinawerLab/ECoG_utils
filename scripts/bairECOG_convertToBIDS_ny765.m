...
% Input paths specs
patientID   = 765; % Specify patient's raw folder name here
...
run_start = [138000]; % Manually determined from plot of triggerchannel 
run_end   = [650000]; 
...
exclude_inx = [75 101 116 124:132]; % e.g. 6 12 13 87
