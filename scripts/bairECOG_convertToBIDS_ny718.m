...
badChannels = find(contains(hdr.label,{'SG', 'DSL', 'LEKG', 'REKG', 'DPMT','DAMT'}))';
...
fprintf('Reading triggers from data \n');
...
fprintf('Found %d triggers in total \n', length(trigger_onsets));
...
disp('Asserting whether all triggers are in the data')
