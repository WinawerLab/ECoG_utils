...
% Input paths specs
patientID   = 756; % Specify patient's raw folder name here
...
task_label  = {'gesturespractice',...
               ...
               %'boldsat1', ... 
              %};              
run_label = {'01','01'};%'01','01'};
% NOTE in between fingermapping and boldsat, we started 'gestures' but 
...
run_start = 100000; % Manually determined from plot of triggerchannel 
run_end   = 550000; 
...
if makePlot 
    inx_notEEGchans = [find(contains(hdr.chantype, 'ecg')); find(contains(hdr.label, {'DC', 'SG', 'Pleth', 'PR', 'OSAT', 'TRIG', 'ECG'}))];
...
%% HACK FOR PHOTODIODE
trigger_onsets = trigger_onsets([2:21 24:end-1]);
