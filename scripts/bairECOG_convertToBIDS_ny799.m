...
% Input paths specs
patientID   = 799; % Specify patient's raw folder name here
RawDataDir  = '/Users/iiagroen/surfdrive/ECoG/raw/';
BIDSDataDir = '/Users/iiagroen/surfdrive/ECoG/';
...
run_label = {'01','02','01','01', '02','02', '03','03', '04','04'};
...
run_start = [105000]; % Manually determined from plot of triggerchannel 
run_end   = [1320000]; 
...
exclude_inx = [4 65 66 70 88 117:122]; 

% Specify reasons for marked as bad, e.g. spikes, elipeptic,
% outlierspectrum, lowfreqdrift
BADCHANNELS_MANUALTABLE = [num2cell(exclude_inx)' repmat({'outofrange'}, [length(exclude_inx) 1])]; 
...
if makePlot 
    inx_notEEGchans = [find(contains(hdr.chantype, 'ecg')); find(contains(hdr.label, {'EKG', 'ECG', 'DC', 'SG', 'Pleth', 'PR', 'OSAT', 'TRIG'}))];
