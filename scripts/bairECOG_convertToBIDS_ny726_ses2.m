...
%% PATIENT-SPECIFIC HACK

% The data recordings start with triggers of a broken off prf run. Remove
% that part of the data:

run_start = 440000; % manually determined from plot of triggerchannel (DC1)
data = data(:,run_start:end);
...
exclude_inx = [1 47 69 70 79 80 81 82 83 84 97 98 101 104 106 108 109 110 113 116 119 120 123 127 129 130 131 132 133 134 135 136 137 147 163 195 209 227 255 256]; % list of consecutive elec numbers
