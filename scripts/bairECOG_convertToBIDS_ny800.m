...
% Input paths specs
patientID   = 800; % Specify patient's raw folder name here
...
run_label = {'01','02','01','01','02','02','03'};
...
run_start = [92626]; % Manually determined from plot of triggerchannel 
run_end   = [993317]; 
